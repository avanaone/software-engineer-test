...
class Test2{
    ...
    public static function init(){
        echo "Type A File";
        static::process_typeA_file();

        echo "Type B File";
        static::process_typeB_file();
    }

    //This for processing type a file
    public static function process_typeA_file(){
        $worksheet = new WorksheetA( __DIR__ . '/../Type_A.xlsx' );
        $worksheet->printThisErrors();
    }

    //This for processing type b file
    public static function process_typeB_file(){
